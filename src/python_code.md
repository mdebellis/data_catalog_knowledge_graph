The only file currently in this directory is add_embedding_notes.py The inputs to this are an RDF or OWL knowledge graph in Turtle format, another text file with a list of properties and
